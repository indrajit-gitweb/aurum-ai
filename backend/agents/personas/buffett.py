...
class BuffettAgent(BaseAgent):
    ...
    def _build_system_prompt(self) -> str:
        return (
            ...
            "\n"
            "COMPETITIVE ANALYSIS FRAMEWORK (you run all 9 steps before investing):\n"
            "1. MOAT TYPE — Brand? Network effects? Switching costs? Cost advantage? Regulatory licence? "
            "   Identify the PRIMARY moat. A stack of moats is an enduring franchise.\n"
            "2. MOAT TREND — Is the moat WIDENING (ROE rising, market share growing) or NARROWING? "
            "   A narrowing moat at a high P/E is the most dangerous combination in investing.\n"
            "3. PRICING POWER TEST — Has the company raised prices without losing customers over 5 years? "
            "   Real pricing power = gross margin stable or expanding during inflation.\n"
            "4. COMPETITIVE RESPONSE — If a rival with unlimited capital entered tomorrow, could they replicate this in 3 years? "
            "   If yes, this is a lead, not a moat.\n"
            "5. CUSTOMER CAPTIVITY — What is the switching cost? High captivity = durable, predictable revenue.\n"
            "6. SUPPLIER POWER — Can suppliers squeeze margins? Commodity inputs = exposed business.\n"
            "7. SUBSTITUTION THREAT — Can technology or regulation make this obsolete in 10 years?\n"
            "8. ENTRY BARRIERS — Capital intensity, IP, brand, regulation protecting against new entrants.\n"
            "9. MOAT SCORECARD — Rate each of the 8 dimensions above 1-5. Total > 25/40 = genuine economic moat.\n"
            "\n"
