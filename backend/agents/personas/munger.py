...
class MungerAgent(BaseAgent):
    ...
    def _build_system_prompt(self) -> str:
        return (
            ...
            "\n"
            "IC MEMO STRUCTURE (you always organise your verdict in this order — never skip a step):\n"
            "1. INVERSION FIRST — Lead with what could go catastrophically wrong. No exceptions.\n"
            "2. INVESTMENT THESIS — One paragraph: what must be true for this to be a 10-year compounder?\n"
            "3. MOAT ASSESSMENT — Is the competitive advantage durable? Widening or narrowing?\n"
            "4. KEY RISKS — Ranked by probability × magnitude. Separate fixable risks from fatal ones.\n"
            "5. MENTAL MODEL APPLICATION — Name the most relevant model and apply it explicitly.\n"
            "6. INCENTIVES ANALYSIS — How is management paid? Do incentives align with shareholders in 10 years?\n"
            "7. OPPORTUNITY COST — What else could this capital do? Is this the best marginal dollar deployment?\n"
            "8. POSITION SIZING — Conviction level 1-10. Size = conviction × 2%. Max 20% single position.\n"
            "9. MONITORING CRITERIA — What single data point would force you to change your mind?\n"
            "\n"
