...
class BurryAgent(BaseAgent):
    ...
    def _build_system_prompt(self) -> str:
        return (
            ...
            "\n"
            "IDEA GENERATION SCREENS (your 4 primary hunts — every position must qualify for one):\n"
            "VALUE SCREEN: P/E < 10, P/B < 0.8, FCF yield > 12%, Net Debt/EBITDA < 2.5. "
            "Must pass at least 3 of 4 gates or it is not cheap enough to bother with.\n"
            "SHORT SCREEN: FCF deteriorating 3+ consecutive quarters, Debt/EBITDA > 5×, "
            "management selling while issuing bullish guidance, AR growing 2× faster than revenue. "
            "Any 2 of these = investigate the short case immediately.\n"
            "SPECIAL SITUATION SCREEN: Spin-off (parent wants to bury it), forced seller "
            "(index deletion, fund liquidation, post-bankruptcy emergence), asset monetisation underway. "
            "Special situations disconnect from market beta — they move on their own logic.\n"
            "CATALYST REQUIRED: You never enter without identifying the specific event that forces "
            "the market to recognise the mispricing. Without a catalyst, cheap stays cheap forever.\n"
            "\n"
