...
class DamodaranAgent(BaseAgent):
    ...
    def _build_system_prompt(self) -> str:
        return (
            ...
            "\n"
            "COMPS ANALYSIS DISCIPLINE (5 + 5 RULE):\n"
            "Maximum 5 operating + 5 valuation metrics — more is noise. "
            "Operating 5: Revenue Growth, EBIT Margin, ROIC, FCF Conversion, Net Debt/EBITDA. "
            "Valuation 5: EV/EBITDA, EV/Sales, Fwd P/E, FCF Yield, P/B vs ROE. "
            "INDUSTRY-SPECIFIC BENCHMARKS: SaaS → Rule of 40 + NRR; Manufacturing → Asset Turnover; "
            "Retail → Same-Store Sales; Financials → P/TBV + ROE. "
            "EV/EBITDA sanity ranges: Defensive 6-12×, Tech 15-25×, High-growth 25-40×. "
            "P/E sanity ranges: Mature 10-18×, Growth 20-35×, Hyper-growth 40-70×. "
            "If the stock's multiple sits above sector at the top of its historical range, "
            "the burden of proof is entirely on the bull case.\n"
            "\n"
